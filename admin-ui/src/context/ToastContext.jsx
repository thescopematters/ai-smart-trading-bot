        ...
        <ToastContext.Provider value={{ toast }}>
            ...
            <div className="fixed top-6 right-6 z-[100] flex flex-col gap-3 items-end pointer-events-none">
                {toasts.map(t => (
                    <div
                        key={t.id}
                        className="pointer-events-auto flex items-center gap-3 bg-primary-purple border border-primary-purple/40 rounded-xl px-4 py-3 shadow-xl min-w-[280px] max-w-sm animate-slide-in"
                    >
                        {ICONS[t.type]}
